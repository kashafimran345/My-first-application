...
class _MyHomePageState extends State<MyHomePage> {
  int _counter = 0;
  bool activeFlateButtonColor = true;
  bool activeRaisedButtonColor = true;
  bool activeKashafButtonColor = true;
  ...
  void changeFlatButtonColor() {
    setState(() {
      activeFlateButtonColor = !activeFlateButtonColor;
    });
  }
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            FlatButton(
              ...
              color: activeFlateButtonColor ? Colors.deepOrange : Colors.black,
            ),
            RaisedButton(
            ...
            Text(
              "Kashaf",
              style: TextStyle(
                  color: activeKashafButtonColor ? Colors.blue : Colors.red),
            ),
            FlatButton(
              onPressed: changeFlatButtonColor,
